...
class FeedbackClass extends CBitrixComponent
{
    ...
    function showArResult()
    {
        echo "test";
        $arResult["test"] = $arParams["EMAIL_TO"];
        $arResult["PARAMS_HASH"] = "sadasdsad";
        return $arResult;
    }

    public function executeComponent()
    {
        $this->arResult = array_merge($this->arResult, $this->showArResult($this->arParams));
